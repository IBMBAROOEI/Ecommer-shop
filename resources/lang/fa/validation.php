...
return array(
    ...
    'custom' => array(),
    'attributes' => array(
        'image'=>"عکس اپلود نشده",
        'color'=>"رنگ",
        'sku'=>"کد محصول",
        "name_categorie" =>"دسته بندی",
        "name_product"=>"نام محصول",
        "code_product"=>"کد محصول",
        "discription_product"=>"محصول توضیح ندارد",
        "price"=>"قیمت وارد کنید",
        "stock"=>"تعداد وارد کنید",
        "brand_id"=>"برند را وارد نکردید",
        "brand_id"=>"برند را وارد نکردید",
        "sub_ategories_id"=>"دسته بندی را انتخاب کنید",
        "name" => "نام",
        "username" => "نام کاربری",
