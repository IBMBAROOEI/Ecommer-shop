      ...
      <div class="login-box">
        <form class="login-form" action="index.html">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" placeholder="نام کاربری" autofocus>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="utility">
              <div class="animated-checkbox">
                <label>
                  <input type="checkbox"><span class="label-text">مرا به خاطرت نگهدار</span>
                </label>
              </div>
              <p class="semibold-text mb-2"><a href="#" data-toggle="flip">کلمه عبورتو فراموش کردی؟</a></p>
            </div>
          </div>
        ...
        <form class="forget-form" action="index.html">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-lock"></i>کلمه عبورتو فراموش کردی؟</h3>
          <div class="form-group">
            <label class="control-label">شماره موبایل</label>
            <input class="form-control" type="text" placeholder="شماره موبایل">
          </div>
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block"><i class="fa fa-unlock fa-lg fa-fw"></i>ریست</button>
          </div>
          <div class="form-group mt-3">
            <p class="semibold-text mb-0"><a href="#" data-toggle="flip"><i class="fa fa-angle-left fa-fw"></i> برگشت به صفحه ورود</a></p>
          </div>
        </form>
      </div>
    </section>
