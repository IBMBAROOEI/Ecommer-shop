...
<main class="app-content">
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-lg-3">
      <div class="widget-small info coloured-icon"><i class="icon fa fa-thumbs-o-up fa-3x"></i>
        <div class="info">
          <h4>میزان رای کاربران از محصولات</h4>
          <p><b>25</b></p>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="tile">
        <h3 class="tile-title"> میزان خرید در سال</h3>
    ...
    <div class="col-md-6">
      <div class="tile">
        <h3 class="tile-title">تعداد درخواست کاربران به سایت</h3>
        <div class="embed-responsive embed-responsive-16by9">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="tile">
        ...
        <p class="mt-4 mb-4"><a class="btn btn-info mr-2 mb-2" href="https://github.com/PurTahan/vali-admin" target="_blank"><i class="fa fa-github"></i>GitHub</a><a class="btn btn-success mr-2 mb-2" href="https://github.com/PurTahan/vali-admin/archive/master.zip" target="_blank"><i class="fa fa-download"></i>Download</a></p>
      </div>
    </div>
    <div class="col-md-6">
      <div class="tile">
